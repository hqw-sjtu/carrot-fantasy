...
## [2.18.0] - 2026-04-16 00:33
### Maintenance | 定时维护
- 🔧 语法检查: 69个Python文件通过
- ✅ 测试覆盖: 691测试用例通过, 1个headless兼容问题
- 📊 代码统计: 19,228行
...
## [2.12.9] - 2026-04-15 01:25
### Features | 新功能
- ✨ **天气粒子特效系统 (Weather Effect)** - 工艺品级别氛围增强:
  - 支持5种天气: 晴/雨/雪/樱花/秋叶
  - 动态风力与粒子物理
  - 平滑天气过渡效果
  - 对象池优化性能
...
### Quality | 质量
- 🧪 语法检查通过 (59个Python文件, 17200+行)
- ✅ 测试覆盖: 566 测试用例 (+17 new)
- 🔧 配置文件验证通过
- 🏗️ 天气系统代码审查通过

---

## [2.12.8] - 2026-04-15 00:25
### Features | 新功能
- ✨ **防御塔图鉴系统 (Tower Bestiary)** - 新增收集玩法:
  - 记录玩家见过的所有塔类型
  - 统计击杀数与伤害输出
  - JSON格式持久化存储
  - 单例模式全局访问
...
### Quality | 质量
- 🧪 语法检查通过 (58个Python文件, 16700+行)
- ✅ 测试覆盖: 549 测试用例 (539通过 + 10新测试)
- 🔧 配置文件验证通过
- 🏗️ 对象池/蓝图系统稳定运行
...
## [2.12.7] - 2026-04-14 23:25
### Features | 新功能
- ✨ **技能冷却光晕特效** - 工艺品级别视觉增强:
  - 新增 add_glow_ring() 方法支持自定义光晕
  - 动态扩散消失动画
  - 自动清理过期光晕
- 📖 **技能冷却测试套件** - 新增 7 个测试用例:
  - 初始化/绑定/状态更新测试
...
### Quality | 质量
- 🧪 语法检查通过 (所有 57 个 Python 文件, 16423 行)
- ✅ 测试覆盖: 539 测试用例全通过
- 🔧 配置文件验证通过 (6 塔类型, 10 波次)
- ⚡ 代码总量: 16,423 行
